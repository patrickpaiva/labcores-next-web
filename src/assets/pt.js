export default {
  ...
  FOOTER_MADE_BY_STUDENTS:
    'Feito pelos alunos do projeto de extensão do Lab CORES',
  ...
  URBAN_CENTER_2:
    'Cidades Inteligentes; Crowdsensing; Colaborações Oportunísticas (sensoriamento oportunístico, redes oportunísticas); Mobilidade Urbana.',
  ...
  ACADEMY_2:
    'Scientometrics (métricas da ciência e produção); Altmetrics (métricas alternativas que visam quantificar outros aspectos da ciência, como impacto na população); Tech mining; Grandes dados acadêmicos (Técnicas para aplicação em dados acadêmicos massivos).',
  AREAS: 'Áreas',
  OF: 'de',
  ...
  INTEL_ECO_3:
    'Educação; Empreendedorismo e Inovação; Gestão do Conhecimento; Sistemas de Apoio à Decisão; Emergência; Governança; Formação de Equipes; Justiça, Responsabilidade, Transparência e Ética na Web.',
  ...
  COMPUTATIONAL_ETHICS_2:
    'Ética Aplicada; Ética Computacional; Ética em Pesquisa (todas estas dedicadas a análise e mineração de redes sociais ou computação social); Metaciência; Teoria crítica; Transparência.',
  ...
  TOXIC_DIGITAL_CONTENT_2:
    'Modelos de Propagação de Informação em Multirrede; Topologias de Redes; Identificação de influenciadores; Identificação de padrões textuais e contextuais; Identificação de Comunidades; Formação de Times; Proveniência da Informação; Letramento Midiático; Crowdsourcing. ',
  BIG_SOCIAL_DATA: 'Big Social Data',
  LAB_CORES_TEXT: 'O Lab CORES realiza pesquisas usando ',
  LAB_CORES_PROPOSAL:
    'Nossa proposta é resolver problemas do mundo real e promover o bem-estar nas populações.',
  ...
  MEET_OUR_TEAM_TEXT:
    'Nossos pesquisadores variam desde pós-doutores até estudantes de graduação.',

...
import {
  ...
  ContentLeft,
  ContentRight
} from '../styles/pages/ResearchAreas'
...
const ResearchAreas: React.FC = () => {
  ...
  return (
    <Container>
      <Header />
      <Banner
        title={translate.RESEARCH_AREAS}
      ...
      <main>
        ...
        <ContentLeft>
          <div className="section">
            ...
            <div className="box">
              ...
              <p>
                {translate.URBAN_CENTER_1}
                <br />
                <br />
                <strong>{translate.RESEARCH_TOPICS}</strong>:{' '}
                {translate.URBAN_CENTER_2}
              </p>
            </div>
          </div>
        </ContentLeft>
        ...
        <div className="area" id="ecosystems">
          ...
          <p>
            ...
            {translate.INTEL_ECO_1}
            <br />
            {translate.INTEL_ECO_2}
            <br /> <br />
            <strong>{translate.RESEARCH_TOPICS}</strong>:{' '}
            {translate.INTEL_ECO_3}
          </p>
        </div>
        <div className="area" id="monitoring">
          ...
          <p>
            ...
            {translate.SENSING_MONITORING_1}
            <br />
            {translate.SENSING_MONITORING_2}
            <br /> <br />
            <strong>{translate.RESEARCH_TOPICS}</strong>:{' '}
            {translate.SENSING_MONITORING_3}
          </p>
        </div>
        ...
        <div className="area" id="data">
          ...
          <p>
            <img
              src="/images/data.png"
              alt="Data Engineering and Semantic Treatment"
            />
        ...
        <div className="area" id="ethics">
          ...
          <p>
            ...
            <br />
            <strong>{translate.RESEARCH_TOPICS}</strong>:{' '}
            {translate.COMPUTATIONAL_ETHICS_2}
          </p>
        </div>
        <div className="area" id="data">
          ...
          <p>
            ...
            <br />
            <strong>{translate.RESEARCH_TOPICS}</strong>:{' '}
            {translate.TOXIC_DIGITAL_CONTENT_2}
          </p>
        </div>
      </main>
      <Footer />

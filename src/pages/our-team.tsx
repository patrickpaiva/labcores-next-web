    ...
    <Container>
      ...
      <main>
        <div className="content">
          <h2>
            {translate.MEET} <span>{translate.LABCORES}</span> {translate.TEAM}
          </h2>
          <div className="head">
            ...
            <div className="headContent">
              ...
              <div className="joniceText">
                ...
                <a href="https://www.joniceoliveira.net/">
                  {translate.SEE_MORE}
                </a>
              </div>
            </div>
          ...
          <TeamContainer>
            ...
            <button
              ...
              onClick={e => handleLeftClick(e, 3)}
            >
              <img src="/images/chevron-icon.png" alt="arrow left" />
            </button>
            <button
              className="chevronRight"
              onClick={e => handleRightClick(e, 3)}
            >
              <img src="/images/chevron-icon.png" alt="arrow left" />
            </button>
            <div
              className="teamContent"
              ref={item => (sliders.current[3] = item)}
            >
          ...
          <TeamContainer>
            ...
            <button
              className="chevronLeft"
              onClick={e => handleLeftClick(e, 2)}
            >
              <img src="/images/chevron-icon.png" alt="arrow left" />
            </button>
            <button
              className="chevronRight"
              onClick={e => handleRightClick(e, 2)}
            >
              <img src="/images/chevron-icon.png" alt="arrow left" />
            </button>
            <div
              className="teamContent"
              ref={item => (sliders.current[2] = item)}
            >
          ...
          <TeamContainer>
            ...
            <button
              className="chevronLeft"
              onClick={e => handleLeftClick(e, 0)}
            >
              <img src="/images/chevron-icon.png" alt="arrow left" />
            </button>
            <button
              className="chevronRight"
              onClick={e => handleRightClick(e, 0)}
            >
              <img src="/images/chevron-icon.png" alt="arrow left" />
            </button>
            <div
              className="teamContent"
              ref={item => (sliders.current[0] = item)}
            >
          ...
          <TeamContainer>
            ...
            <button
              className="chevronLeft"
              onClick={e => handleLeftClick(e, 1)}
            >
              <img src="/images/chevron-icon.png" alt="arrow left" />
            </button>
            <button
              className="chevronRight"
              onClick={e => handleRightClick(e, 1)}
            >
              <img src="/images/chevron-icon.png" alt="arrow left" />
            </button>
            <div
              className="teamContent"
              ref={item => (sliders.current[1] = item)}
            >
          ...
          <TeamContainer>
            ...
            <button
              className="chevronLeft"
              onClick={e => handleLeftClick(e, 4)}
            >
              <img src="/images/chevron-icon.png" alt="arrow left" />
            </button>
            <button
              className="chevronRight"
              onClick={e => handleRightClick(e, 4)}
            >
              <img src="/images/chevron-icon.png" alt="arrow left" />
            </button>
            <div
              className="teamContent"
              ref={item => (sliders.current[4] = item)}
            >
